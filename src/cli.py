...
def __parse_args__():
    ...
    parser.add_argument("--from_pretrained_bert", type=str, default=None)
    ...
    parser.add_argument("--cls_token_id", type=int, default=2)
    ...
    parser.add_argument("--discriminator_size", type=int, default=None)
